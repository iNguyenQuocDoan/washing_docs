...
| 7 | `bookings` | ✅ Done | `feature/bookings` (pushed, chờ merge) | Main flow — atomic capacity, tier window check, state machine, cashier search phone/plate, customer `note` field (D-04), service-duration fit check (D-05) |
